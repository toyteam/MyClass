		...
		<div class="text-center">
			<div class="col-md-7 col-sm-5 background-white text-center">
				...
				<div class="col-md-12 col-sm-12">
					<br /><br /><br />
					<form class="form-horizontal form-label-left" method="post" action="/manage/form/editform">
						<div id="form-show">
							<?php 
						...
						<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3">
							...
							<input type="hidden" id="data" name="data" value='<?php foreach ($html as $key => $value) {
								echo "%%@@".$value[1];
							} ?>'>
